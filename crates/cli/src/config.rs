...
use crate::{commands::{launch::GameOptions, profile::no_profile_dir}, config::known_paths::OptionalPathExt};
...
impl Options {
    pub fn merge(self, other: Self) -> Self {
        Self {
            ...
            game: other.game.into_iter().chain(self.game.into_iter()).collect(),
